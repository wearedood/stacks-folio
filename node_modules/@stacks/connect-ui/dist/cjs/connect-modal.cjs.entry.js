...
var index = require('./index-DuJURnb6.js');
...
const Modal = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '486a8b0d4c08fb0f38d26584880b40975ce74939', class: "modal-container animate-in fade-in fixed inset-0 z-[8999] box-border flex h-full w-full items-end bg-[#00000040] md:items-center md:justify-center" }, index.h("div", { key: '54488652b87fb84e0bfc37e0dce83bdc252b2eee', class: "fixed inset-0 z-[8999]", onClick: () => this.handleCloseModal() }), index.h("div", { key: '21c5463a21e285951dee580db2b2e097fb071ece', class: "modal-body animate-in md:zoom-in-50 slide-in-from-bottom md:slide-in-from-bottom-0 z-[9000] box-border flex max-h-[calc(100%-24px)] w-full max-w-full cursor-default flex-col overflow-y-scroll rounded-2xl rounded-b-none bg-white p-6 text-sm leading-snug shadow-[0_4px_5px_0_#00000005,0_16px_40px_0_#00000014] md:max-h-[calc(100%-48px)] md:w-[400px] md:rounded-b-2xl" }, index.h("div", { key: '33064b362a40aafb47fa497bcfe12c7c0b9862e7', class: "flex flex-col space-y-[10px]" }, index.h("div", { key: '788b6280717355a38938750f5157eade7118ef7f', class: "flex items-center" }, index.h("div", { key: '327d62d08c8acc81692930cfb99a23e7b45cbae5', class: "flex-1 text-xl font-medium text-[#242629]" }, "Connect a wallet"), index.h("button", { key: '61e2400cc41284e4f6df15718578558dd1667efd', class: "rounded-full bg-transparent p-1 transition-colors hover:bg-gray-100 active:scale-95", onClick: () => this.handleCloseModal() }, index.h("span", { key: '5bda5e860b382e9aaf47b66c2e91759cfd02d736', class: "sr-only" }, "Close popup"), index.h("img", { key: '450a865711c1c31693d90f2cbcfe9763bae553db', src: closeIconSvg }))), hasInstalled ? (index.h("p", null, "Select the wallet you want to connect to.")) : (index.h("p", null, "You don't have any wallets in your browser that support this app. You need to install a wallet to proceed."))), hasInstalled && (index.h("div", { key: '2ee090d1eab36f553d6ed7565e2e2588eabcecd7', class: "mt-6" }, index.h("p", { key: '1bad5b095f034f12c0cfb88f76f0d7a02d23cc13', class: "mb-4 text-sm font-medium" }, "Available wallets"), index.h("ul", { key: '06140f18abb2ae4334d2c9bfd603246898eac7ef', class: "space-y-3" }, this.installedProviders.map((provider, i) => {
            var _a;
            return (index.h("li", { class: "flex items-center gap-3 rounded-[10px] border border-[#EFEFF2] p-[14px]", key: (_a = provider === null || provider === void 0 ? void 0 : provider.id) !== null && _a !== void 0 ? _a : i }, index.h("div", { class: "aspect-square basis-9 overflow-hidden" }, index.h("img", { src: provider.icon, class: "h-full w-full rounded-[10px] bg-gray-700" })), index.h("div", { class: "flex-1" }, index.h("div", { class: "text-sm font-medium text-[#242629]" }, provider.name), provider.webUrl && (index.h("a", { href: provider.webUrl, class: "text-sm", rel: "noopener noreferrer" }, new URL(provider.webUrl).hostname))), index.h("button", { class: "rounded-[10px] border border-[#333] bg-[#323232] px-4 py-2 text-sm font-medium text-[#EFEFEF] shadow-[0_1px_2px_0_#0000000A] outline-[#FFBD7A] transition-all hover:bg-[#0C0C0D] hover:text-white hover:shadow-[0_8px_16px_0_#00000020] focus:outline focus:outline-[3px] active:scale-95", onClick: () => this.handleSelectProvider(provider.id) }, "Connect")));
        })))), hasMore && (index.h("div", { key: 'e6869330825d48b2bb7a8bfc7f292dcd1c0cdf9b', class: "mt-6" }, hasInstalled ? (index.h("p", { class: "mb-4 text-sm font-medium" }, "Other wallets")) : (index.h("div", { class: "mb-5 flex justify-between" }, index.h("p", { class: "text-sm font-medium" }, "Recommended wallets"), index.h("a", { class: "flex cursor-pointer items-center space-x-[5px] text-xs transition-colors hover:text-[#242629] hover:underline focus:underline", href: "https://docs.hiro.so/what-is-a-wallet", rel: "noopener noreferrer", target: "_blank" }, index.h("svg", { xmlns: "http://www.w3.org/2000/svg", width: "14", height: "14", viewBox: "0 0 16 16", fill: "none" }, index.h("path", { stroke: "#74777D", "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "1.2", d: "M8.006 15a7 7 0 1 0 0-14 7 7 0 0 0 0 14Z" }), index.h("path", { stroke: "#74777D", "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "1.2", d: "M5.97 5.9a2.1 2.1 0 0 1 4.08.7c0 1.4-2.1 2.1-2.1 2.1M8.006 11.5h.01" })), index.h("p", null, "What is a wallet?\u2009", index.h("span", { class: "align-text-bottom text-[9px]" }, "\u2197"))))), index.h("ul", { key: 'e8ede6e513ebe32e8aee0385a727f9c454b5f9f2', class: "space-y-3" }, notInstalledProviders.map((provider, i) => {
            var _a;
...
//# sourceMappingURL=connect-modal.entry.cjs.js.map

//# sourceMappingURL=connect-modal.cjs.entry.js.map