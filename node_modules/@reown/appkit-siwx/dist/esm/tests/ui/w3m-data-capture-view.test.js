...
describe('W3mDataCaptureView', () => {
    ...
    describe('Loading States', () => {
        ...
        it('should hide recent emails widget during loading', async () => {
            ...
            const recentEmailsWidgetInitial = HelpersUtil.querySelector(element, 'w3m-recent-emails-widget');
            ...
            const recentEmailsWidgetDuringLoading = HelpersUtil.querySelector(element, 'w3m-recent-emails-widget');
            expect(recentEmailsWidgetDuringLoading).toBeNull();
            // Wait for request to complete (100ms mock + 300ms component delay)
            await new Promise(resolve => setTimeout(resolve, 450));
            // Recent emails widget should be present again after loading
            const recentEmailsWidgetAfterLoading = HelpersUtil.querySelector(element, 'w3m-recent-emails-widget');
