...
var ICONS = {
  add: async () => (await import("./add-5Z27N4J7.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-LFU727SK.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-44BOIPGK.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-5QQT7AJF.js")).appStoreSvg,
  apple: async () => (await import("./apple-EL4BGRPO.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-GQYTRSVQ.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-6HXLESX6.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-QYA6APLT.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-E7FKGZJW.js")).arrowTopSvg,
  bank: async () => (await import("./bank-BA2G7BPW.js")).bankSvg,
  browser: async () => (await import("./browser-WP732H2V.js")).browserSvg,
  bin: async () => (await import("./bin-NYHBRMU5.js")).binSvg,
  bitcoin: async () => (await import("./bitcoin-RAQGKNIM.js")).bitcoinSvg,
  card: async () => (await import("./card-3BDSXQAL.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-3M4NL4DF.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-SWGFEUXI.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-AVJ73PDE.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-LQ37CVWA.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-P6HCYNFW.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-2T3ZQDQU.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-6SNISS5V.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-775PGBW4.js")).clockSvg,
  close: async () => (await import("./close-IJISU6UL.js")).closeSvg,
  compass: async () => (await import("./compass-ZIBOPIGI.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-5NFM2GDK.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-FAAXHJTI.js")).copySvg,
  cursor: async () => (await import("./cursor-PATAOG3Y.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-2EOGXCWD.js")).cursorTransparentSvg,
  circle: async () => (await import("./circle-3S7AKQHP.js")).circleSvg,
  desktop: async () => (await import("./desktop-VXGMIVV2.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-XV5JALHH.js")).disconnectSvg,
  discord: async () => (await import("./discord-Y25DMLDO.js")).discordSvg,
  ethereum: async () => (await import("./ethereum-E7OB3YBJ.js")).ethereumSvg,
  etherscan: async () => (await import("./etherscan-225JLTDI.js")).etherscanSvg,
  extension: async () => (await import("./extension-IX4X7MZ2.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-ZEEDPRDH.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-F6RTHS4Q.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-JKAPCFUH.js")).farcasterSvg,
  filters: async () => (await import("./filters-FZ7FVZPK.js")).filtersSvg,
  github: async () => (await import("./github-5XFZBDAO.js")).githubSvg,
  google: async () => (await import("./google-76AB5BWX.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-FKBEXEQK.js")).helpCircleSvg,
  image: async () => (await import("./image-J7TPHDPP.js")).imageSvg,
  id: async () => (await import("./id-5P7RMKHB.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-5K2K67AN.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-FIPSZKTF.js")).lightbulbSvg,
  mail: async () => (await import("./mail-XC42ZKPY.js")).mailSvg,
  mobile: async () => (await import("./mobile-7OCLZNCF.js")).mobileSvg,
  more: async () => (await import("./more-EM3XMZQ3.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-DS7X222B.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-IZFBDG4O.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-YSDEZWQX.js")).offSvg,
  playStore: async () => (await import("./play-store-MO4VIYVP.js")).playStoreSvg,
  plus: async () => (await import("./plus-MQS5X446.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-QRATW2II.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-5JHVR2AQ.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-K7ZBPH3W.js")).refreshSvg,
  search: async () => (await import("./search-FPQNZVPS.js")).searchSvg,
  send: async () => (await import("./send-DSSOD3BN.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-Y5SGO5TP.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-4ASLNYII.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-BFQM5MXX.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-X2PFSEW6.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-U2IDOVZX.js")).swapVerticalSvg,
  solana: async () => (await import("./solana-WRUXAVSF.js")).solanaSvg,
  telegram: async () => (await import("./telegram-HJ2YWXRB.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-VAOJMBVT.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-XXAEA2W2.js")).twitchSvg,
  twitter: async () => (await import("./x-PNDCEHST.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-UJO5DZMM.js")).twitterIconSvg,
  user: async () => (await import("./user-ZULJIZBH.js")).userSvg,
  verify: async () => (await import("./verify-ATZCUV6C.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-NSNOGOXV.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-MWSRE66Y.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-UJD5SD2X.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-UJD5SD2X.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-UJD5SD2X.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-SNMVPOLS.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-BNEHLHT4.js")).warningCircleSvg,
  x: async () => (await import("./x-PNDCEHST.js")).xSvg,
  info: async () => (await import("./info-YHXAEDXH.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-QAJMMTPP.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-MEETLNQM.js")).reownSvg,
  "x-mark": async () => (await import("./x-mark-S2ROF47Q.js")).xMarkSvg
};
...
lit-html/development/directives/until.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-MSQCNGQA.js.map
