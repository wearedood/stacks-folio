...
export const fetchPortfolio = async (address: string): Promise<PortfolioData> => {
  ...
  // NFTs — fetch base list then enrich with metadata in parallel
  ...
  // Fetch metadata for up to 20 NFTs in parallel
